  ...
  async function startTutorialCampaign() {
    const tutorialMap = maps.find((map) => map.file === "Европа.json");
    const tutorialScenario = scenarios.find((scenario) => scenario.file === "Европа 2026.json");
