...
const remove = new Set(["AGS XM8","T92E1A","M551 Sheridan","T110E3A","T110E4A","T110E4B","T110E5A","T110E5B","M60 Patton","M60A2","Chrysler K","XM2001A"]);
const rows = fs.readFileSync(file,"utf8").trimEnd().split(/\r?\n/).map(parse).filter((row)=>!remove.has(row[0]));
setRow(rows,"M5 Stuart",3,["M24 Chaffee Prototype","M3 Satan"]);
setRow(rows,"M24 Chaffee Prototype",4,["M41 Walker Prototype"]);
setRow(rows,"M41 Walker Prototype",5,["M24 Chaffee"]);
setRow(rows,"M24 Chaffee",6,["M41 Walker Bulldog"]);
setRow(rows,"M41 Walker Bulldog",7,["T49"]);
setRow(rows,"T49",8,["T92E1"]);
setRow(rows,"T92E1",9,["M551 Sheridan (ПТУР)"]);
...
setRow(rows,"T110E4 prototype",7,["T110E4 early"]);
setRow(rows,"T110E4 early",8,["T110E4 late"]);
setRow(rows,"T110E4 late",9,["T110E4"]);
setRow(rows,"T110E4",10,[]);
setRow(rows,"T110E5 prototype",7,["T110E5 early"]);
setRow(rows,"T110E5 early",8,["T110E5 late"]);
setRow(rows,"T110E5 late",9,["T110E5"]);
...
setRow(rows,"M53/55",6,["T92 HMC prototype"]);
setRow(rows,"T92 HMC prototype",7,["XM2001 Crusader"]);
